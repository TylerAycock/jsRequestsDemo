...
//endpoint that we need to hit in order to get our information 

app.get('/characters', (req, res) => {
    console.log('hit chars')
    res.status(200).send(characters)
})
//the above console log shows up on whatever server we are runnign 
//this on so in this case it'll be our own terminals
